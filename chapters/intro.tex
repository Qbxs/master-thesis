...
Parametric polymorphism, subtyping and type classes all deal with generalising functions for specific types and enable us to reason about such programs.
