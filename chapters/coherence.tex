...
That means the types that we declare instances for have to be \emph{non-overlapping downwards} or the two lower sets of the types declared do not contain any non-trivial types. \todo{what does that mean? uninhabited?}
...
In our type system, $\top$ is couninhabited because... \todo{is it?}
