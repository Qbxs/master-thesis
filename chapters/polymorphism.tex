...
Similarily with subtyping we can define a type $\mathit{Fractional}$ as the union (or a common supertype) of all types that are instances of \mintinline{Haskell}{Fractional} representing all fractional numbers and make it a subtype of $\mathit{Number}$ represented as the union of all types that stand for numbers.
