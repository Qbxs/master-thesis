...
If our type system doesn't allow ad-hoc polymorphism it may seem neccessary to write verbose code for basic functions with respect to every concrete type it should be used for.
