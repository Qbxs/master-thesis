...
\begin{figure}[h]
    \begin{center}
        ...
        \AxiomC{$\Gamma \vdash x_1 : \sigma_1 \toConstr \Xi_1$}
        \AxiomC{$\Gamma \vdash x_n : \sigma_n \toConstr \Xi_2$}
        \AxiomC{$\mathit{Fresh}(\beta)$}
        \RightLabel{\textsc{Method}}
        \TrinaryInfC{$\Gamma \vdash \mathbf{m} \; x_1 \dots x_n : \tau \toConstr \{ \Phi_m(\beta) \} \cup \Xi_1 \cup \Xi_2$}
        \DisplayProof
