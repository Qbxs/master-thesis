...
With \textsc{Sub}$^+$ and the subtyping rules in fig. \ref{fig:subtyping} we can derive several useful rules:
...
The \textsc{Sub}$^+$ rule seems intuitive for this:
...
We again differentiate co- and contravariant type classes in order to transport type classes over the subtyping relation.
 ...
 \begin{center}
  \AxiomC{}
  \RightLabel{\textsc{Top}}
  \UnaryInfC{$\mathit{top} : \tau \sub \top$}
  \DisplayProof
  {\hskip.2in}
  \AxiomC{}
  \RightLabel{\textsc{Bot}}
  \UnaryInfC{$\mathit{bot} : \bot \sub \tau$}
  \DisplayProof
\end{center}
 ...
 \begin{center}
    \AxiomC{$f : \tau \sub \sigma$}
    \RightLabel{\textsc{JoinI}$_1$}
    \UnaryInfC{$in_1(f) : \tau \sub \sigma \join \rho$}
    \DisplayProof
    {\hskip.2in}
    \AxiomC{$f: \tau \sub \sigma$}
    \RightLabel{\textsc{JoinI}$_2$}
    \UnaryInfC{$in_2(f) : \tau \sub \rho \join \sigma$}
    \DisplayProof
 \end{center}
 ...
 \begin{prooftree}
  ...
  \BinaryInfC{$\mathit{join}(f,g) : \tau \join \sigma \sub \rho$}
\end{prooftree}
  ...
  \begin{center}
    \AxiomC{$f : \tau \sub \rho$}
    \RightLabel{\textsc{MeetI}$_1$}
    \UnaryInfC{$\mathit{proj_1}(f) : \tau \meet \sigma \sub \rho$}
    \DisplayProof
    {\hskip.2in}
    \AxiomC{$f : \sigma \sub \rho$}
    \RightLabel{\textsc{MeetI}$_2$}
    \UnaryInfC{$\mathit{proj_2}(f) : \tau \meet \sigma \sub \rho$}
    \DisplayProof
 \end{center}
 ...
 \begin{prooftree}
  ...
  \BinaryInfC{$\mathit{meet}(f,g) : \tau \sub \sigma \meet \rho$}
 \end{prooftree}
...
For \textsc{Sub}$^+$ and \textsc{Sub}$^-$ we can resolve witnesses like this:
