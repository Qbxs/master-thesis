...
\emph{instances trivially satisfy the type they are declared for which is not listed} (fig. \ref{fig:satisfiability-example})
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\caption{Satsifiability for co- and contravariant predicates for data and codata}
