...
In the lattice of types, the types that satisfy a covariant predicate form a downwards closed set.
...
In the lattice of types, the types that satisfy a contravariant predicate form a n upwards closed set.
