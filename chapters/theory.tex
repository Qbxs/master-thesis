...
\caption{Derivation for $\ctx \Showable(\mathcal{U} \meet \mathbb{N})$}
\end{figure}
...
\caption{Derivation for $\ctx \Defaultable(\mathbb{Z} \join \mathcal{B})$}
\end{figure}
\section{Witnesses}
...
% TODO: after merge, move this to next chapter
